...
export const restaurantBookingRelations = relations(
  restaurantBooking,
  ({ one }) => ({
...
export const bookingProviderRelations = relations(
  bookingProvider,
  ({ many }) => ({
    restaurantBookings: many(restaurantBooking),
  }),
...
export const restaurantSchedulesRelations = relations(
  restaurantSchedules,
  ({ one }) => ({
    restaurant: one(restaurant, {
...
export const restaurantScheduleRelations = relations(
  restaurantSchedule,
  ({ many }) => ({
    restaurantSchedules: many(restaurantSchedules),
  }),
...
export const restaurantAwardDistinctionRelations = relations(
  restaurantAwardDistinction,
  ({ one }) => ({
...
export const restaurantAwardRelations = relations(
  restaurantAward,
  ({ one, many }) => ({
...
export const awardDistinctionRelations = relations(
  awardDistinction,
  ({ one, many }) => ({
    restaurantAwardDistinctions: many(restaurantAwardDistinction),
    awardType: one(awardType, {
...
export const ingredientCategoryRelations = relations(
  ingredientCategory,
  ({ one }) => ({
...
export const coffeeRoastersRelations = relations(
  coffeeRoasters,
  ({ one, many }) => ({
    location: one(locations, {
...
export const coffeeProducersRelations = relations(
  coffeeProducers,
  ({ many }) => ({
    coffeeBeans: many(coffeeBeans),
  }),
...
export const coffeeVarietalsRelations = relations(
  coffeeVarietals,
  ({ many }) => ({
    coffeeBeans: many(coffeeBeans),
  }),
...
export const fbAffinityEntryRelations = relations(
  fbAffinityEntry,
  ({ one }) => ({
...
export const restaurantCuisineRelations = relations(
  restaurantCuisine,
  ({ one }) => ({
    restaurant: one(restaurant, {
